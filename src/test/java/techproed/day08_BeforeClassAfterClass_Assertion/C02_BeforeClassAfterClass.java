...
public class C02_BeforeClassAfterClass {
    /*
    BeforeClass ve AfterClass test methodlarımızdan önce bir sefer çalışmasını istediğimiz kodları bu methodlara
    koyarız. Mesela testlerimiz başlamadan önce database bağlantısı yapmak için kullanılabilir yada hangi driver'i
    kullanacaksak yine bunu BeforeClass'a koyabiliriz. Aynı şekilde testlerimizden sonra database'i sonlandırmak için
    yada raporlarımzı sonlandırmak için de kullanabiliriz.
     */
    WebDriver driver;
    @BeforeClass
